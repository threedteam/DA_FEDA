...
import pandas as pd
import numpy as np
from Sensor_Drift.model import FeatureExtractor,class_classifier,Domain_classifier
from Sensor_Drift.loaddataset import train_loader,test_loader
from Sensor_Drift import train,test,params
...
def main(train_mode,FeatureExtractor,class_classifier,Domain_classifier,train_loader,test_loader):
    ...
    for epoch in range(params.epochs):
        ...
        train.train(train_mode,feature_extractor,class_classifier,domain_classifier,class_criterion,domain_criterion,
                       src_train_dataloader,tgt_trian_dataloader,optimizer,epoch)
        accuracy = test.test(feature_extractor,class_classifier,domain_classifier,src_test_dataloader,tgt_test_dataloader)
